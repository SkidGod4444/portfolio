...
export const DATA = {
  ...
  avatarUrl: "/me.jpg",
  connect: "Let's connect and build something cool together. Feel free to reach out to me. I'm always open to new opportunities and collaborations. Reach out to me via **email: (connect.saidev@gmail.com)** or dm me on [Twitter](https://dub.sh/saidev-twitter) or [Instagram](https://dub.sh/saidev-instagram).",
  skills: [
    "React",
    "Next.js",
    "Typescript",
